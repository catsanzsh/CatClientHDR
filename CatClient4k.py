...
# Define theme colors
THEME = {
    'bg': '#e6f0ff',          # Very light blue
    'sidebar': '#ffffff',      # White
    'accent': '#007bff',      # Bright Blue
    'text': '#00264d',          # Dark Blue
    'text_secondary': '#b0b0b0', # Silver/Light Grey
    'button': '#ffffff',      # White
    'button_hover': '#f0f0f0', # Very light grey/silverish
    'input_bg': '#f8f9fa'      # Very light grey/off-white
}
